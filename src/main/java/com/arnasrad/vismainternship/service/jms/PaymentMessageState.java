...
import com.arnasrad.vismainternship.mapper.payment.PaymentRequestMapper;
...
public class PaymentMessageState {
    ...
    public PaymentRequest mapDTOAndSave(PaymentRequestDTO paymentRequestDTO, String state) {
