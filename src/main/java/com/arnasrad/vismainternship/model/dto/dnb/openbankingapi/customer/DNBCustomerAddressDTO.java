...
public class DNBCustomerAddressDTO extends CustomerAddressDTO {
    ...
    public DNBCustomerAddressDTO() {
    }

    public DNBCustomerAddressDTO(String postalCode, String addressLine1, String postalAddressCountry,
