...
public class DnbCustomerInfoMapper {
    ...
    public CustomerInfoDto mapToCustomerInfoDto(DnbCustomerInfoDto dnbCustomerInfoDto) {
        CustomerInfoDto customerInfoDto = new CustomerInfoDto();

        customerInfoDto.setFirstName(dnbCustomerInfoDto.getFirstName());
        customerInfoDto.setLastName(dnbCustomerInfoDto.getLastName());
        customerInfoDto.setAddress(dnbCustomerInfoDto.getAddress());
        customerInfoDto.setPhone(dnbCustomerInfoDto.getPhone());
        customerInfoDto.setEmail(dnbCustomerInfoDto.getEmail());
        customerInfoDto.setCountryOfBirth(dnbCustomerInfoDto.getCountryOfBirth());
