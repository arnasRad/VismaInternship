...
public class AccountController {
    ...
    @Autowired
    public AccountController(OptionalValueProcessorService optionalValueProcessorService, AccountServiceFactory accountServiceFactory) {
    ...
    public List<? extends Account> getAccounts(@RequestParam String bank) throws BadRequestException, NoSuchFunctionalityException {

        return accountServiceFactory.getService(optionalValueProcessorService.getRequestParameterValue("bank", bank)).getAccounts();
    }
}
